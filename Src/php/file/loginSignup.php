...
<html lang ="it">
<head>
    <title> Log in - I tesori di Squitty </title>
    <meta name="title" content="Trama" >
    <meta name="author" content="Simone Ballarin">
    <meta name="description" content="login page della pasticceria i tesori di Squitty" >
...
<body>
	...
	if(isset($_POST['login']))
		{
			if(isset($_POST['email']) && isset($_POST['password']))
			{
				...
				$b = $a->validateUser($email, $password);	//*********VALIDATEUSER NON FUNZIONA PERCHE IL "" DEL PASSWORD VENGONO TOLTO DA CLEANINPUT******************
	...
	echo "</br>".$ErrLogin."</br>";
	echo "Email: <input type='email' name='email' placeholder='mickey.mouse@gmail.com' required><span class='err'>".$ErrEm."</span></br></br>";
	echo "Password:<input type='password' name='password' placeholder='insert your password' required ><span class='err'>".$ErrPassw."</span></br></br>";
	echo "<input type='submit' name = 'login' value='Log in'></br></br>";
	echo "</fieldset>";
	echo "</form>";
	echo "</div>";
	...
	echo "<input type='submit' name = 'signup' value='Sign up'></br>";
	echo "</form>";
	echo "</div>";
	}
	else{
		echo "<div id='signupForm'>";
				echo "<form action=''  method='POST'>";
					echo "<fieldset>";
						...
						echo "</br>".$ErrSignup;
						echo "Nome:";
						echo "<input type='text' name='nome'  placeholder='insert your name' required><span class='err'>".$ErrNome."</span></br>";
						echo "</br>";
						echo "Cognome:";
						echo "<input type='text' name='cognome'  placeholder='insert your surname' required><span class='err'>".$ErrCognome."</span></br>";
						echo "</br>";
						echo "Tipo utente:";
						echo "<select name='tipoUtente' required>
							...
							</select><span class='err'>".$ErrTipoUtente."</span></br>";
						echo "</br>";
						echo "Email:";
			...
			echo "<form action='' method='POST'></br></br>";
			echo "<p>If you have an account click the following button to login to your account.</br>";
			echo "<input type='submit' name = 'returnToLogin' value='Log in'></br>";
	echo "</form>";
	echo "</div>";
		}
